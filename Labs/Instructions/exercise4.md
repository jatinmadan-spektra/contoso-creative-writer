...
1. Now, as you are inside `api` directory, run the below command to run the orchestrator.
   ...
   >Wait till the process completes successfully

1. Now that you have run the orchestrator without tracing, we will be enabling tracing.
...
1. Navigate back to your application, which is running in a browser. Generate an article to check the working of the orchestrator.
...
1. As you verified the logs of your application, now it's time to evaluate the response quality of the application. The 4 metrics the evaluators in this project assess are Coherence, Fluency, Relevance, and Groundedness.
